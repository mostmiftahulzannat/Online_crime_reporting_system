    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        ...
        @csrf
          ...
          <div class="form-group">
            <label for="email" class="sr-only">{{ __('Confirm Password') }}</label>
            <input id="password-confirm" type="password" class="form-control form-control-lg" name="password_confirmation" placeholder="Re-Type Password" required autocomplete="new-password">
          </div>
        ...
        <div class="text-center" style="margin-top: -10%;">
                        <p class="text-gray-600">Do you have an account? <a href="{{ route('login') }}" class="font-bold">Sign
                                in</a>.</p>
